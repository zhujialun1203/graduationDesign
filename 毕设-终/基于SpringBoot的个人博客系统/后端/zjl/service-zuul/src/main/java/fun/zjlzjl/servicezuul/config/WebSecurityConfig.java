package fun.zjlzjl.servicezuul.config;

import fun.zjlzjl.servicezuul.service.UserService;
import fun.zjlzjl.servicezuul.service.impl.SecurityUserService;
...
//        web.ignoring().antMatchers("/blogimg/**")
//        web.ignoring().antMatchers("/index");
//        web.ignoring().antMatchers("/static/**");
        web.ignoring().antMatchers("/reg");
        web.ignoring().antMatchers("/api-article/article/show/**");
